...
class ContentCategory(models.Model):
    ...
    type = models.CharField(
        max_length=20, choices=CategoryType.choices, default=CategoryType.GAME
    )
...
class ContentArticle(models.Model):
    ...
    summary = models.TextField(
        max_length=500,
        help_text="Brief summary for previews")
    ...
    author = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="content_articles"
    )
    categories = models.ManyToManyField(
        ContentCategory, related_name="articles")
    ...
    featured_image = models.ImageField(
        upload_to="content_images/featured/", blank=True, null=True
    )
    banner_image = models.ImageField(
        upload_to="content_images/banners/", blank=True, null=True
    )
    ...
    is_premium = models.BooleanField(
        default=False, help_text="Requires subscription to view"
    )
    is_verified = models.BooleanField(
        default=False, help_text="Verified by experts")
...
class ContentArticleView(models.Model):
    ...
    article = models.ForeignKey(
        ContentArticle, on_delete=models.CASCADE, related_name="article_views"
    )
    ...
    scroll_depth = models.IntegerField(
        default=0, help_text="Percentage of page scrolled"
    )
...
class ContentArticleComment(models.Model):
    ...
    article = models.ForeignKey(
        ContentArticle, on_delete=models.CASCADE, related_name="comments"
    )
    author = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="content_comments"
    )
    parent = models.ForeignKey(
...
class ContentBookmark(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="content_bookmarks"
    )
    article = models.ForeignKey(
        ContentArticle, on_delete=models.CASCADE, related_name="bookmarked_by"
    )
...
class ContentSeries(models.Model):
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, related_name="created_series"
    )
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class ContentQuiz(models.Model):
    ...
    article = models.ForeignKey(
        ContentArticle, on_delete=models.CASCADE, related_name="quizzes"
    )
    title = models.CharField(max_length=255)
    description = models.TextField(blank=True, null=True)
...
class ContentQuizAttempt(models.Model):
    ...
    quiz = models.ForeignKey(
        ContentQuiz, on_delete=models.CASCADE, related_name="attempts"
    )
    user = models.ForeignKey(
...
class ContentLearningPath(models.Model):
    ...
    articles = models.ManyToManyField(
        ContentArticle, related_name="learning_paths")
    required_articles = models.ManyToManyField(
        ContentArticle, related_name="required_for_paths"
    )
    order = models.IntegerField(default=0)
...
class UserLearningProgress(models.Model):
    ...
    learning_path = models.ForeignKey(
        ContentLearningPath, on_delete=models.CASCADE, related_name="user_progress"
    )
    status = models.CharField(
    ...
    completed_articles = models.ManyToManyField(
        ContentArticle, related_name="completed_by_users"
    )
...
class ContentReport(models.Model):
    ...
    reporter = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="content_reports"
    )
    article = models.ForeignKey(
        ContentArticle, on_delete=models.CASCADE, related_name="reports"
    )
