...
from .serializers import (CookieConsentSerializer, LegalDocumentSerializer,
...
class UserConsentView(generics.CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        document = get_object_or_404(
            LegalDocument, id=document_id, is_active=True)
...
class AcceptTermsView(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        terms = get_object_or_404(
            LegalDocument, id=terms_id, type="TERMS", is_active=True
        )
        privacy = get_object_or_404(
            LegalDocument, id=privacy_id, type="PRIVACY", is_active=True
        )
