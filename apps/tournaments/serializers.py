...
class TournamentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Tournament
        fields = '__all__'
        read_only_fields = ('organizer', 'current_players', 'total_matches', 'total_viewers', 'created_at', 'updated_at')
...
class TournamentParticipantSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = '__all__'
        read_only_fields = ('registered_at', 'checked_in_at', 'wins', 'losses', 'draws', 'points', 'rank')
