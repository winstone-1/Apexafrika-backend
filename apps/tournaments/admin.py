...
class TournamentAdmin(admin.ModelAdmin):
    list_display = ('name', 'game', 'status', 'organizer', 'start_date', 'current_players', 'max_players')
...
class MatchAdmin(admin.ModelAdmin):
    list_display = ('tournament', 'round_number', 'player1', 'player2', 'status', 'scheduled_time')
