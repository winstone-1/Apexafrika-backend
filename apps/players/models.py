...
class PlayerStats(models.Model):
    ...
    win_rate = models.FloatField(default=0.0, validators=[MinValueValidator(0), MaxValueValidator(100)])
...
class PlayerMatchHistory(models.Model):
    player = models.ForeignKey(User, on_delete=models.CASCADE, related_name='match_history')
    opponent = models.ForeignKey(User, on_delete=models.CASCADE, related_name='match_history_as_opponent')
