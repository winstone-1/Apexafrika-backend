    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField()),
                ('post_type', models.CharField(choices=[('TEXT', 'Text'), ('IMAGE', 'Image'), ('VIDEO', 'Video'), ('CLIP', 'Game Clip'), ('ANNOUNCEMENT', 'Announcement')], default='TEXT', max_length=20)),
                ('media_url', models.URLField(blank=True, null=True)),
                ('media_file', models.FileField(blank=True, null=True, upload_to='community_media/')),
                ...
                ('tournament', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='posts', to='tournaments.tournament')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.AddIndex(
            model_name='post',
            index=models.Index(fields=['tournament'], name='community_p_tournam_f94e9a_idx'),
        ),
